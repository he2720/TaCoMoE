...
class Qwen2MLP(nn.Module):
    ...
    def forward(self, hidden_state, **kwargs):
        ...
        return self.down_proj(self.act_fn(self.gate_proj(hidden_state, **kwargs)[0]) * self.up_proj(hidden_state, **kwargs)[0], **kwargs)
...
class Qwen2SdpaAttention(Qwen2Attention):
    ...
    def forward(
        ...
        **kwargs
        ...
        query_states, expert, con_loss = self.q_proj(hidden_states,**kwargs)
        
        key_states, expert, con_loss = self.k_proj(hidden_states,**kwargs)
        value_states, expert, con_loss = self.v_proj(hidden_states,**kwargs)
        ...
        return attn_output, None, past_key_value, expert, con_loss
...
class Qwen2DecoderLayer(nn.Module):
    ...
    def forward(
        ...
        cache_position: Optional[torch.LongTensor] = None,
        task_id: Optional[torch.LongTensor] = None,
        depart: Optional[torch.LongTensor] = None,
        **kwargs,
        ...
        hidden_states, self_attn_weights, present_key_value, expert, con_loss = self.self_attn(
            hidden_states=hidden_states,
            attention_mask=attention_mask,
            position_ids=position_ids,
            past_key_value=past_key_value,
        ...
        hidden_states = self.mlp(hidden_states, **kwargs)[0]
        ...
        **kwargs,
        ...
        for decoder_layer in self.layers:
            ...
            if len(layer_outputs)==4:
                ...
                hidden_states, _, expert, con_loss = layer_outputs
            else:
                hidden_states, expert, con_loss = layer_outputs
